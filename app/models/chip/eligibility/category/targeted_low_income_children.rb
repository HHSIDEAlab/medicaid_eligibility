...
module Chip::Eligibility::Category
  class TargetedLowIncomeChildren < Ruleset
    ...
    config "CHIP Targeted Low Income Child Age Low Threshold", "State configuration table", "Numeric", "Default 0"
    config "CHIP Targeted Low Income Child Age High Threshold", "State configuration table", "Numeric", "Default 19"
